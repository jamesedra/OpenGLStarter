...
int projections_3D_main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "3D Projections", NULL, NULL);
	if (window == NULL)
	{
	...
	Shader texShader("src/shaders/projections/projections.vert", "src/shaders/projections/texturing_only.frag");
	texShader.use();
