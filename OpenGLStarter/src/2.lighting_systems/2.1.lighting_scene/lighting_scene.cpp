...
int lighting_scene_main()
{
	...
	GLFWwindow* window = glfwCreateWindow(W_WIDTH, W_HEIGHT, "Lighting Systems", NULL, NULL);
	if (window == NULL)
	{
	...
	Shader shader("src/shaders/lighting/vertex.vert", "src/shaders/lighting/base.frag");
